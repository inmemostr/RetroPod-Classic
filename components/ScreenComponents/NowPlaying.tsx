...
export const NowPlaying: React.FC<NowPlayingProps> = ({ song, isPlaying, progress, duration, isLoading }) => {
  if (!song) {
    return (
  ...
  return (
    <div className="flex-1 flex bg-white overflow-hidden relative">
      ...
      <div className="w-1/2 relative bg-gray-50 flex items-center justify-center border-l border-gray-200 shadow-[inset_2px_0_5px_rgba(0,0,0,0.05)]">
        {isLoading && (
          <div className="absolute top-2 left-1/2 -translate-x-1/2 z-20 text-[9px] text-gray-400 animate-pulse">
            Loading...
          </div>
        )}
